...
namespace og\db\model\relation;
...
class BelongsToMany extends Relation
{
    ...
    {
        $class = $this->pivotName ?: '\\og\db\\model\\Pivot';
        $pivot = new $class($this->parent, $data, $this->middle);
        if ($pivot instanceof Pivot) {
            return $pivot;
        } else {
            throw new Exception('pivot model must extends: \og\db\model\Pivot');
        }
    }
