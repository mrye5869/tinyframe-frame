...
[![Build Status](https://travis-ci.org/webmozart/console.svg?branch=1.0.0-beta5)](https://travis-ci.org/webmozart/console)
...
[![Scrutinizer Code Quality](https://scrutinizer-ci.com/g/webmozart/console/badges/quality-score.png?b=1.0.0-beta5)](https://scrutinizer-ci.com/g/webmozart/console/?branch=1.0.0-beta5)
...
```php
use og\console\Webmozart\Console\UI\Component\Table;
...
```php
use og\console\Webmozart\Console\UI\Component\Table;
use og\console\Webmozart\Console\UI\Component\TableStyle;
...
If you are having problems, send a mail to 55585190@qq.com or shout out to
