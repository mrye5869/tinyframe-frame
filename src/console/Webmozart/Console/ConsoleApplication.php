...
namespace og\console\Webmozart\Console;
...
use og\console\Webmozart\Console\Api\Command\CannotAddCommandException;
...
use og\console\Webmozart\Console\Api\Config\CommandConfig;
use og\console\Webmozart\Console\Api\Event\ConfigEvent;
...
use og\console\Webmozart\Console\Args\ArgvArgs;
use og\console\Webmozart\Console\IO\ConsoleIO;
use og\console\Webmozart\Console\UI\Component\ExceptionTrace;
...
class ConsoleApplication implements Application
{
    ...
    public function __construct($config)
    {
        ...
        Assert::isInstanceOf($config, 'og\console\Webmozart\Console\Api\Config\ApplicationConfig', 'The $config argument must be an ApplicationConfig or a callable. Got: %s');
